...
const control = "mt-2 min-h-12 w-full border border-charcoal/20 bg-white/55 px-4 py-3 text-base font-normal normal-case tracking-normal outline-none transition placeholder:text-charcoal/35 hover:border-charcoal/35 focus:border-terracotta focus:ring-2 focus:ring-terracotta/15";
...
export function FreeAuditForm({ locale = "en" }: { locale?: Locale }) {
  ...
  return <form id="application" onSubmit={submit} onFocus={markStarted} noValidate className="relative min-w-0 scroll-mt-6 border border-charcoal/15 bg-cream p-6 shadow-[10px_10px_0_#C89B3C] sm:p-9 sm:shadow-[12px_12px_0_#C89B3C]">
