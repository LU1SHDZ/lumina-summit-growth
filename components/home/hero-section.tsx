...
export function HeroSection({ locale = "en" }: { locale?: Locale }) {
  const copy = locale === "es" ? {
    ...
    sprint: "Solicita una auditoría gratuita →",
    audit: "Conoce el Sprint",
    ...
    sprint: "Request a free growth audit →",
    audit: "Explore the Sprint",
